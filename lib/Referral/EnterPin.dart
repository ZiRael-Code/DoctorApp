...
class _AppointmentPaymentScreen extends  State<EnterPin> {
                ...
                Align(
                  ...
                  Column(
                    children: [
                      ...
                      const Text(textAlign: TextAlign.center, 'Enter PIN', style: TextStyle(fontSize: 28, fontWeight: FontWeight.bold),),
