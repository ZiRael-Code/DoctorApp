...
class SeferSomeone extends StatefulWidget {
  const SeferSomeone({super.key});

  @override
  State<SeferSomeone> createState() => _SeferSomeoneState();
}

class _SeferSomeoneState extends State<SeferSomeone>
