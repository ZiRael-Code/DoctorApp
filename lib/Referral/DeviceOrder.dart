...
class _DeviceOrderState extends State<DeviceOrder>
              ...
              children: [
                ...
                Expanded(
                  child: TabBarView(
                    controller: _tabController,
                    children: [
                      Center(child: currentOrder()),
                      Center(child: orderADevice()),
                    ],
                  ),
                ),
              ],
  ...
  currentOrder() {
    return Column(
      children: [
        ...
        order(deviceName: 'Wellue BP2 connect device ', text: '25th June 2022'),
        const SizedBox(
          height: 20,
        ),
        order(deviceName: 'Wellue BP2 connect device ', text: '25th June 2022'),
  ...
  order({required deviceName, isShipped, required String text}) {
    return Container(
      child: Container(
