          ...
          child: Column(
            children: [
              blog(
                  ...
                  title:
                      "BEST PRACTICES TO REDUCE RISK OF PROSTATE CANCER IN MEN.",
                  description:
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                  ...
                  child: GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(
                            color: const Color(0xffC4DCFF), width: 0.5),
                      ),
                      child: const Row(
                        children: [
                          Text(
                ...
                const SizedBox(
                    height: 16), // Space between "See More" and bottom row
                // Row with eye icon, view count, and text
                Row(
                  children: [
                    const Icon(Icons.remove_red_eye,
                        size: 23, color: Colors.black), // Eye icon
                    const SizedBox(
                        width: 8), // Space between icon and views count
                    Text(
                      views,
                      style: const TextStyle(fontSize: 14, color: Colors.black),
                    ),
