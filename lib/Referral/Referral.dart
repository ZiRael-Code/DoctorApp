import 'package:doctor_app/Referral/ReferDoctor.dart';
import 'package:doctor_app/Referral/ReferPharmacy.dart';
            ...
            child: Column(
              children: [
                ...
                Container(
                  ...
                  child: const Align(
                    child: Text(
                      "Invite your friends and earn commissions when they buy devices.",
                  ...
                  children: [
                    GestureDetector(
                      onTap: () => Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => const ReferDoctor())),
                      child: referOption(
                    ...
                    GestureDetector(
                      onTap: () => Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => const ReferPharmacy())),
                      child: referOption(
